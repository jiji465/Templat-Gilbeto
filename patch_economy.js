...
const regex = /<View>\s*<View style=\{styles\.stepCard\}>\s*<View style=\{\[styles\.stepNumberBox, \{ backgroundColor: colors\.primary \}\]\}>\s*<Text style=\{styles\.stepNumberText\}>01<\/Text>\s*<\/View>[\s\S]*?<\/View>\s*<\/View>/;
